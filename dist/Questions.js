...
const javaQ = [
    ...
    },
    {
        ...
        answer: "B",
        explanation: "The output will be 'Bye' because the value of the string variable 'str' is reassigned to 'Bye' before printing.",
    },
    {
    ...
    },
    {
        ...
        answer: "B",
        explanation: "The condition (i == 8) could not be satisfied hence nothing cannot be printed.",
    },
    {
    ...
    },
    {
        ...
        answer: "C",
        explanation: "The static variables declarations just like constants, they required static keyword and an initial value.",
    },
    {
        ...
        answer: "D",
        explanation: "All of the above points are correct with respect to a BigInteger class.",
    },
    {
    ...
    },
    {
        ...
        answer: "A",
        explanation: "The super keyword refers to superclass (parent) objects. It is used to call superclass methods, and to access the superclass constructor.",
    },
    {
    ...
    },
    {
        ...
        answer: "A",
        explanation: "A Wrapper class is a class whose object wraps or contains primitive data types.",
    },
    {
        ...
        answer: "C",
        explanation: "In Java programming language, the wrapper classes are those whose objects wraps a primitive data type within them. The wrapper class is used for converting primitive datatype to object is called boxing.",
    },
    {
    ...
    },
    {
        ...
        answer: "A",
        explanation: "File handling is used for creating, deleting, and modifying files using a java program.",
    },
    {
    ...
    },
    {
        ...
        answer: "A",
        explanation: "The correct absolute path of a file in Java is:\n\nC:\\Program Files\\Java\\jdk1.8.0_131\\bin\\file_name.txt",
    },
    {
    ...
    },
    {
        ...
        answer: "D",
        explanation: "Some common methods of the math library are max(), min(), cbrt(), pow(), log(), log10(), etc.",
    },
    {
        question: "Which method in java is used to generate random numbers in Java?",
        options: {
            A: "random.nextInt()",
            B: "random()",
            C: "rand()",
    ...
    },
    {
        ...
        answer: "B",
        explanation: "The recursion is a process by which a process allow methods to call itself.",
    },
    {
        ...
        answer: "B",
        explanation: "StringBuffer class is used to create modifiable strings in java.",
    },
    {
        ...
        answer: "D",
        explanation: "All of the above (Array, List, and Vector) are valid data structures in Java.",
    },
    {
        ...
        answer: "A",
        explanation: "The syntax to create a vector in Java is:\n\nVector < string > names = new Vector < String > ();",
    },
    {
        question: "What will be the output of following Java code?",
        options: {
    ...
    },
    {
        ...
        answer: "B",
        explanation: "Java method toString() is used to convert an object to string.",
    },
    {
    ...
    {
        question: "Which of the following methods are present in comparator interface?",
        options: {
            A: "compare()",
            B: "equate()",
            C: "isEqual()",
    ...
    {
        question: "Which of the following statements is not correct for vectors in Java?",
        options: {
    ...
    },
    {
        ...
        answer: "B",
        explanation: "Deadlock in Java is a condition when two or more threads try to access the same resources at the same time.",
    },
    {
    ...
    },
    {
        ...
        answer: "A",
        explanation: "We use call-by-reference to pass objects as arguments to methods in java. Read more: Object as an Argument in Java",
    },
    {
        ...
        answer: "D",
        explanation: "All of the above-mentioned ways are the correct way to create an object Java. There are five different ways to create an object and we will see the ways to create an object given below:\n\nUsing the new keyword\nUsing newInstance() method of Class\nUsing clone() method\nUsing newInstance() method of Constructor class\nUsing deserialization",
    },
    {
    ...
    },
    {
        ...
        answer: "D",
        explanation: "A map in Java is a data structure defined in the java.util package and is represented using key-value pairs.",
    },
    {
        ...
        answer: "A",
        explanation: "A set in Java is represented in the form of values and is used to store unique elements.",
    },
    {
    ...
    },
    {
        ...
        answer: "C",
        explanation: "The multiple threads can be executed concurrently and it has its own priority.",
    },
    {
    ...
    },
    {
        ...
        answer: "B",
        explanation: "The Math.copySign() method returns the first floating-point argument with the sign of the second floating-point argument.",
    },
];
const cppQ = [
    {
        ...
        answer: "C",
        explanation: "C++ programming language was developed by Bjarne Stroustrup at Bell Laboratories (formerly AT&T Bell Laboratories).",
    },
    {
    ...
    },
    {
        ...
        answer: "B",
        explanation: "C++ is a medium-level language because it contains the features of low-level language as well as high-level language (Low-level Vs High-level).",
    },
    {
        ...
        answer: "D",
        explanation: "Keywords are also known as reserved words, there are 95 keywords are available in C++. Some of the C++ keywords are not available in the C language.",
    },
    {
    ...
    },
    {
        ...
        answer: "A",
        explanation: "C++14 was introduced in 2014. It contains the following features:\n\n- polymorphic lambdas\n- digit separators\n- generalized lambda capture\n- variable templates\n- binary integer literals\n- quoted strings",
    },
    {
    ...
    {
        question: "Which of the following whitespace characters can be used in C++?",
        options: {
            A: "Horizontal tab",
            B: "Vertical tab",
            C: "Form feed",
        ...
        answer: "D",
        explanation: "In C++, we can use the following whitespace characters:\n\n- Space\n- Horizontal tab\n- Vertical tab\n- Form feed\n- New-line",
    },
    {
        question: "Which of the following is the correct extension of the C++ source code file?",
        options: {
            A: ".cpp",
            B: ".c++",
            C: "Both",
    ...
    {
        question: "Which of the following command is used for the C++ compiler in Linux OS?",
        options: {
            A: "GCC",
            B: "c++",
            C: "g++",
    ...
    },
    {
        ...
        answer: "B",
        explanation: "C++ is not a pure object-oriented language because it supports the oops concept as well as procedural-oriented features.",
    },
    {
        ...
        answer: "B",
        explanation: "C++ does not support automatic garbage collection. Here we need to free dynamically allocated memory using free() or delete. Otherwise, it may cause memory leaks.",
    },
    {
    ...
    },
    {
        ...
        answer: "D",
        explanation: "C++ supports the following OOPS concept:\n\n- Inheritance\n- Encapsulation\n- Abstraction\n- Polymorphism",
    },
    {
    ...
    },
    {
        ...
        answer: "A",
        explanation: "Yes, C++ is known as a superset of C. Because C++ supports almost all the features of C language.",
    },
    {
        question: "C++ is a more secure programming language compared to C language?",
        options: {
            A: "True",
            B: "False",
            C: "-",
        ...
        answer: "A",
        explanation: "Yes, C++ is a more secure programming language compared to C language because C language does not support encapsulation and information hiding.",
    },
    {
        ...
        answer: "B",
        explanation: "In C++, we use the stream concept for Input/Output operations. It is a sequence of bytes or flow of data that improves performance.",
    },
    {
        question: "If the set of bytes flows from main memory to other devices like printers, the monitor is known as ___.",
        options: {
            A: "Input Operation",
            B: "Output Operation",
            C: "Both of above",
        ...
        answer: "B",
        explanation: "If the set of bytes flows from the main memory to other devices like the printer, the monitor is known as output operation.",
    },
    {
    ...
    },
    {
        ...
        answer: "D",
        explanation: "The cin and cout are the objects of the istream and ostream classes respectively that are used to perform input/output operations.",
    },
    {
    ...
    },
    {
        ...
        answer: "B",
        explanation: 'The "stdout" stands for standard output. It is used to represent standard output devices like the monitor.',
    },
    {
        ...
        answer: "A",
        explanation: "Yes, it is true, the cerr is an object of the ostream class, which is used to output the errors.",
    },
    {
        ...
        answer: "A",
        explanation: 'In C++, "<<" is known as the insertion operator which is used with the "cout" object to print data on the console screen.',
    },
    {
        ...
        answer: "B",
        explanation: 'In C++, ">>" is known as an extraction operator which is used with the "cin" object to read user input.',
    },
    {
        ...
        answer: "A",
        explanation: "The endl is a macro, which is an object of ostream classes, used to print a newline on the console screen.",
    },
    {
    ...
    },
    {
        ...
        answer: "D",
        explanation: "There are 4 types of datatypes in C++:\n\n- Basic Datatype\n- Derived Datatype\n- Enumeration data type\n- User Defined datatype",
    },
    {
        question: "The size of basic datatypes can be changed according to 32 or 64-bit operating systems?",
        options: {
            A: "True",
            B: "False",
            C: "-",
        ...
        answer: "A",
        explanation: "Yes, it is true, the size of basic datatypes can be changed according to 32 or 64-bit operating systems.",
    },
    {
        question: 'If we use value "3.14" then what will be the data type of the given value?',
        options: {
            A: "float",
            B: "double",
            C: "long double",
        ...
        answer: "B",
        explanation: 'If we use any floating-point value with the suffix "F" in C++ that will be double type.',
    },
    {
        question: "Which of the following is the correct format specifier for long double-type values in C++?",
        options: {
            A: "%f",
            B: "%ld",
            C: "%lf",
    ...
    {
        question: "Can we create a character variable that will occupy more than 1 byte in memory?",
        options: {
            A: "True",
            B: "False",
            C: "-",
        ...
        answer: "A",
        explanation: "Yes, in C++, using wchar_t we can declare a variable that will occupy more than 1 byte of memory space.",
    },
    {
    ...
    },
    {
        ...
        answer: "D",
        explanation: "There are 3 types of qualifiers used in C++: Size qualifier, Sign qualifier, Type qualifier",
    },
    {
    ...
    },
    {
        ...
        answer: "B",
        explanation: "In C++, the operator '%' is known as the modulus operator, which is used to find the remainder.",
    },
    {
        ...
        answer: "D",
        explanation: "In C++, the operator '?:' is a ternary operator, it operates on 3 operands, it is also known as a conditional operator.",
    },
    {
        question: "Which of the following operator is known as Scope Resolution Operator?",
        options: {
            A: "::",
            B: "?:",
            C: "->",
    ...
    {
        question: "Which of the following operator is known as Referential Operator?",
        options: {
            A: "!=",
            B: "?:",
            C: "->",
    ...
    {
        question: "Which of the following operator is used to return the address of a variable?",
        options: {
            A: "*",
            B: "->",
            C: "&",
    ...
    {
        question: "Which of the following statement is correct about the global variable?",
        options: {
    ...
    },
    {
        ...
        answer: "B",
        explanation: "The system automatically initializes a global variable whereas we need to initialize local variables explicitly.",
    },
    {
        question: "The default value of a variable that is declared using register storage class?",
        options: {
            A: "0",
            B: "Garbage",
        },
        answer: "B",
        explanation: "The default value of the variable, which is declared using the register storage class is garbage.",
    },
    {
    ...
    {
        question: "Which of the following escape sequence is used to print double quotes on the console screen?",
        options: {
            A: '%"',
            B: '/"',
            C: '*"',
    ...
    {
        question: "Which of the following escape sequence is used to print the percentage symbol on the console screen?",
        options: {
            A: "%%",
            B: "/%",
            C: "*%",
        ...
        answer: "A",
        explanation: "The escape sequence %% is used to print the percentage symbol on the console screen.",
    },
    {
        question: "Which of the following statement is correct about default arguments?",
        options: {
        ...
        answer: "B",
        explanation: "In C++, we can create functions with default arguments. The default arguments are used with a default value that is not mandatory to be passed into the function.",
    },
    {
        question: "Which of the following condition is correct for the default arguments?",
        options: {
        ...
        answer: "A",
        explanation: "In C++, we can create functions with default arguments. The default arguments must be the last argument in the function declaration.",
    },
    {
        question: "Which of the following function can be called without any arguments?",
        options: {
    ...
    {
        question: 'Which of the following function will be called with the independent syntax "sample(10,20,30);"?',
        options: {
        ...
        answer: "D",
        explanation: 'In the above options, option D is correct. Option C is incorrect because the return type is "float" and the syntax given is independent which means it doesn\'t return any value.',
    },
    {
        question: "Which of the following is an incorrect call to the function void sample(int a, int b=0, int c=0)?",
        options: {
            A: "sample(10,20,30);",
            B: "sample();",
            C: "sample(50);",
    ...
    {
        question: "Which of the following statement is not correct about Default arguments?",
        options: {
        ...
        answer: "A",
        explanation: "Default arguments are not allowed with pointer and reference to function declaration.",
    },
    {
        question: "The default argument gets bound during declaration but is executed during the function call?",
        options: {
            A: "True",
            B: "False",
            C: "-",
        ...
        answer: "A",
        explanation: "Yes, the default argument gets bound during declaration but is executed during the function call.",
    },
    {
    ...
    },
    {
        ...
        answer: "B",
        explanation: "There are following sequence of statements is available in C++: Pre-processor directives, Comments, Declarations, Function Declarations, Executable statements.",
    },
    {
        ...
        answer: "D",
        explanation: "In C++, Decision-making statements are: IF statements, Switch Statements, Conditional operators.",
    },
    {
        question: "Which of the following statement can replace the if-else statement?",
        options: {
            A: "while loop",
            B: "do-while loop",
            C: "for loop",
    ...
    {
        question: "Which of the following is the best option to make decisions for multiple choices?",
        options: {
            A: "if",
            B: "if-else",
            C: "if-else-if",
    ...
    {
        question: "Can we use the string in the Switch statement for case selection?",
        options: {
            A: "True",
            B: "False",
            C: "-",
        ...
        answer: "B",
        explanation: "In C++, we cannot use the string in Switch statement for case selection.",
    },
    {
        ...
        answer: "A",
        explanation: 'While loop is an entry control loop, in a "while" loop we need to check the condition before executing the loop body.',
    },
    {
        ...
        answer: "B",
        explanation: 'The do-while loop is an entry control loop, in the "while" loop we need to check the condition before executing the loop body.',
    },
    {
        question: "Which of the following loop is normally used for a menu-driven program?",
        options: {
            A: "Do While loop",
            B: "For loop",
            C: "While loop",
    ...
    {
        question: "Which of the following loop, in which we have to execute the body of the loop before checking the condition?",
        options: {
            A: "Do While loop",
            B: "For loop",
            C: "While loop",
        ...
        answer: "A",
        explanation: "In the Do-while loop, we have to execute the body of the loop before checking the condition.",
    },
    {
        question: "Which of the following types of variables can be used in the Switch statement for case selection?",
        options: {
            A: "int, float, char",
            B: "int, char",
            C: "int, double",
    ...
    {
        question: 'In switch statements, Expression in parenthesis "()" after the switch statement is mandatory?',
        options: {
            A: "True",
            B: "False",
            C: "-",
    ...
    {
        question: 'Which of the following statement is correct about the "break" statement?',
        options: {
    ...
    {
        question: "Which of the following statement is used to quit the loop immediately?",
        options: {
            A: "break",
            B: "continue",
            C: "while",
    ...
    {
        question: 'Which of the following statement is also known as a "switch" statement?',
        options: {
    ...
    {
        question: 'Which of the following statement is also known as a "continue" statement?',
        options: {
            A: "goto statement",
            B: "bitwise statement",
    ...
    {
        question: 'Which of the following is the correct syntax of the "do-while" loop?',
        options: {
    ...
    {
        question: 'Which of the symbol is used with the label in the "goto" statement?',
        options: {
            A: "@",
            B: ":",
            C: "#",
    ...
    {
        question: "Which of the following loop is the best option when the number of iterations is known?",
        options: {
            A: "While loop",
            B: "For loop",
            C: "Do while loop",
    ...
    {
        question: "Which of the following given option is used to complete the function declaration?",
        options: {
            A: "Semicolon",
            B: "Colon",
            C: "Comma",
    ...
    {
        question: "Which of the following are the mandatory part of the function prototype?",
        options: {
        ...
        answer: "B",
        explanation: "The function name and return type are the mandatory part of the function prototype.",
    },
    {
        ...
        answer: "C",
        explanation: 'The above program will generate a syntax error because we use a semicolon in the definition of the sayHello() function. The correct program is given below:\n\n#include <iostream>\nusing namespace std;\n\nvoid sayHello()\n{\n    cout << "Hello World";\n}\n\nint main()\n{\n    sayHello();\n    return 0;\n}',
    },
    {
        question: "Can we use the return type void in the main() function in a C++ program?",
        options: {
            A: "Yes",
            B: "No",
            C: "-",
        ...
        answer: "B",
        explanation: 'No, we cannot use the return type void in the main () function, we have to use the return type "int" with the main() function.',
    },
    {
        question: "Which of the following is a more effective way to call a function with arguments?",
        options: {
            A: "Call by value",
            B: "Call by reference",
            C: "Call by address",
        ...
        answer: "B",
        explanation: 'The "call by reference" is a more effective way to call a function with arguments because it reduces the overall time and memory use.',
    },
    {
        question: "How many minimum numbers of functions are required to execute a C++ program?",
        options: {
            A: "1",
            B: "2",
            C: "3",
        ...
        answer: "A",
        explanation: "To execute a C++ program, we required only 1 function which is the main() function. Because the main() function is the entry point for the program.",
    },
    {
        question: "What is the lifetime of a static variable declared in a user-defined function?",
        options: {
        ...
        answer: "C",
        explanation: "The lifetime of a static variable is in the whole program. But its scope is within the function only.",
    },
    {
        question: "Which of the following statement is correct about inline function?",
        options: {
    ...
    {
        question: "A function that is defined inside a class without any complex statement will be inline.",
        options: {
            A: "True",
            B: "False",
            C: "-",
        ...
        answer: "A",
        explanation: "Yes, A function that is defined inside a class without any complex statement will be inline.",
    },
    {
        question: "An inline function is substituted at the place of function call during?",
        options: {
            A: "Compile Time",
            B: "Runtime",
        },
        answer: "A",
        explanation: "An inline function is substituted at the place of the function call during compile time.",
    },
    {
    ...
    },
    {
        ...
        answer: "A",
        explanation: "Yes, an inline function is faster than a normal function because it does not require a context switch from function call to function definition.",
    },
    {
    ...
    {
        question: "Can we define the inline function outside the class in C++ program?",
        options: {
            A: "Yes",
            B: "No",
            C: "-",
    ...
    },
    {
        ...
        answer: "B",
        explanation: "No, we cannot access the elements of an array outside the bound in C++. It can generate logical and runtime errors.",
    },
    {
    ...
    {
        question: 'If we create an array "Arr", which is the correct way to access the first element of the array?',
        options: {
            A: "Arr[0]",
            B: "0[Arr]",
            C: "*(Arr+0)",
    ...
    },
    {
        ...
        answer: "A",
        explanation: "Yes, we can create a 4-dimensional array using the below statement. int arr[2][2][2][2];",
    },
    {
    ...
    {
        question: "When we pass an array to the function, then the function call will be?",
        options: {
            A: "Call by value",
            B: "Call by reference",
            C: "Both A and B",
        ...
        answer: "B",
        explanation: 'When we pass an array to the function then the function call will be "call by reference".',
    },
];
const pyQ = [
    {
    ...
    },
    {
        ...
        answer: "A",
        explanation: "Python programming was created by Guido van Rossum. It is also called general-purpose programming language.",
    },
    {
    ...
    },
    {
        ...
        answer: "A",
        explanation: "The float data type is represented by the float class of data types. A true number with a floating-point representation is represented by the symbol. It is denoted by the use of a decimal point. Optionally, the character e or E followed by a positive or negative integer could be appended to the end of the string to indicate scientific notation.",
    },
    {
    ...
    },
    {
        ...
        answer: "C",
        explanation: "With the help of curly braces (), we can define a dictionary that contains a list of key-value pairs that are separated by commas. Each key and its associated value are separated by a colon (:). For example:\n\n```\nd = {\n\t<key>: <value>,\n\t<key>: <value>,\n\t.\n\t.\n\t.\n\t<key>: <value>\n}\n```",
    },
    {
        ...
        answer: "A",
        explanation: "It is possible to define literals in Python as data that is provided in a variable or constant. Literal collections are supported in Python as well as String and Numeric literals, Boolean and Boolean expressions, Special literals, and Special expressions.",
    },
    {
    ...
    },
    {
        ...
        answer: "A",
        explanation: "The if statement is the most fundamental decision-making statement, and it determines whether or not the code should be executed based on whether or not the condition is met. If the condition in the if statement is met, a code body is executed, and the code body is not otherwise executed. The statement can be as simple as a single line of code or as complex as a block of code.",
    },
    {
        ...
        answer: "A",
        explanation: "If is a keyword which works with specified condition. If statement in Python has the subsequent syntax:\n\nif condition:\n    #Will executes this block if the condition is true",
    },
    {
        question: "Amongst which of the following is / are the conditional statement in Python code?",
        options: {
            A: "if a<=100:",
            B: "if (a >= 10)",
            C: "if (a => 200)",
    ...
    },
    {
        ...
        answer: "A",
        explanation: "After the 'if' condition, an else statement is placed immediately after the block. if-else statements are used in programming in the same way that they are used in the English language. The following is the syntax for the if-else statement:\n\nif(condition):\n    Indented statement block for when condition is TRUE\nelse:\t\n    Indented statement block for when condition is FALSE",
    },
    {
    ...
    },
    {
        ...
        answer: "A",
        explanation: "When only one statement needs to be executed within an if block, the short hand if statement is used to accomplish this. This statement can be included in the same line as the if statement, if necessary. When using Python's Short Hand if statement, the following syntax is used:\n\nif condition: statement",
    },
    {
        question: 'What will be the output of the following Python code?\n\nx,y = 12,14\n\nif(x+y==26):\n    print("true")\nelse:\n    print("false")',
        options: {
        ...
        answer: "A",
        explanation: "In this code the value of x = 12 and y = 14, when we add x and y the value will be 26 so x+y= =26. Hence, the given condition will be true.",
    },
    {
        ...
        answer: "A",
        explanation: "In this code the value of x = 13, and the condition 13>12 or 13<15 is true but 13==16 becomes falls. So, the if part will not execute and program control will switch to the else part of the program and output will be 'Given condition did not match'.",
    },
    {
        question: 'Consider the following code segment and identify what will be the output of given Python code?\n\na = int(input("Enter an integer: "))\nb = int(input("Enter an integer: "))\n\nif a <= 0:\n    b = b +1\nelse:\n    a = a + 1\nif inputted number is a negative integer then b = b +1\nif inputted number is a positive integer then a = a +1',
        options: {
        ...
        answer: "C",
        explanation: "In above code, if inputted number is a negative integer, then b = b +1 and if inputted number is a positive integer, then a = a +1. Hence, the output will be depending on inputted number.",
    },
    {
    ...
    },
    {
        ...
        answer: "C",
        explanation: "A single if-else statement requires fewer conditional checks than two consecutives if statements. If the condition is true, the if-else statement is used to execute both the true and false parts of the condition in question. The condition is met, and therefore the if block code is executed, and if the condition is not met, the otherwise block code is executed.",
    },
    {
    ...
    },
    {
        ...
        answer: "A",
        explanation: "It is possible to check multiple expressions for TRUE and to execute a block of code as soon as one of the conditions evaluates to TRUE using the elif statement. The elif statement is optional in the same way that the else statement is. The difference between elif and else is that, unlike else, where there can only be one statement, elif statements can be followed by an arbitrary number of statements.",
    },
    {
        ...
        answer: "C",
        explanation: 'In the above code, the assign value of i = 5 and as mentioned in the condition if 5 > 11: print ("i is greater than 11"), here 5 is not greater than 11 so condition becomes false and there will not be any output and program will be abnormally terminated.',
    },
    {
    ...
    },
    {
        ...
        answer: "A",
        explanation: "The control flow of a program refers to the sequence in which the program's code is executed. Conditional statements, loops, and function calls all play a role in controlling the flow of a Python program's execution.",
    },
    {
        ...
        answer: "B",
        explanation: "It is possible to iterate over a sequence or other iterable objects using the for loop in Python. The process of iterating over a sequence is referred to as traversal. Following syntax can be follow to use for loop in Python Program –\n\nfor val in sequence:\n    ...\n    loop body\n    ...\nFor loop does not require an indexing variable to set beforehand.",
    },
    {
        ...
        answer: "A",
        explanation: "In Python, the word break refers to a loop control statement. It serves to control the sequence of events within the loop. If you want to end a loop and move on to the next code after the loop; the break command can be used to do so. When an external condition causes the loop to terminate, it represents the common scenario in which the break function is used in Python.",
    },
    {
    ...
    },
    {
        ...
        answer: "A",
        explanation: "The range(6) is define as function. Loop will print the number from 0.",
    },
    {
        ...
        answer: "A",
        explanation: "The looping simplifies the complex problems into the easy ones. It enables us to alter the flow of the program so that instead of writing the same code again and again, we can repeat the same code for a finite number of times.",
    },
    {
    ...
    },
    {
        ...
        answer: "A",
        explanation: 'Once a function has been defined, it can be called from another function, a program, or even from the Python prompt itself. To call a function, we simply type the name of the function followed by the appropriate parameters into the command line.\n\nFor example-\n\n```python\n# Define a function\ndef user_name(name):\n    # This function greets the user\n    print("Hello, " + name + ".")\n\n# Call the function\nuser_name("Amit")    # \'Amit\' passed as function argument\n\n# Output: Hello, Amit.\n```',
    },
    {
        question: "Amongst which of the following shows the types of function calls in Python?",
        options: {
            A: "Call by value",
            B: "Call by reference",
            C: "Both A and B",
    ...
    },
    {
        ...
        answer: "A",
        explanation: "If we define a function in Python with parameters, and at the time of calling function it requires parameters. In the above code, passing arguments are 12 and 'deepak'. So, the output will be 'Your id is: 12 and your name is: deepak'.",
    },
    {
        question: "Amongst which of the following is a function which does not have any name?",
        options: {
    ...
    },
    {
        ...
        answer: "A",
        explanation: 'In a function, we can pass any data type as an argument, such as a string or a number or a list or a dictionary, and it will be treated as if it were of that data type inside the function. The following code exemplifies this –\n\n```python\n# Define a function\n\ndef St_list(student):\n  # Iterate through the list\n  for x in student:\n    print(x)\n\n# Create a list\nstudents = ["Anil", "Rex", "Jerry"]\n\n# Call the function and pass the list as an argument\nSt_list(students) \n\n# Output:\n# Anil\n# Rex\n# Jerry\n```',
    },
    {
    ...
    },
    {
        ...
        answer: "A",
        explanation: "File handling is the capability of reading data from and writing it into a file in Python. Python includes functions for creating and manipulating files, whether they are flat files or text documents. We will not need to import any external libraries in order to perform general IO operations because the IO module is the default module for accessing files.",
    },
    {
        ...
        answer: "D",
        explanation: "The key functions used for file handling in Python are: open(), close(), read(), write(), and append(). the open() function is used to open an existing file, close() function is used to close a file which opened, read() function is used when we want to read the contents from an existing file, write() function is used to write the contents in a file and append() function is used when we want to append the text or contents to a specific position in an existing file.",
    },
    {
        ...
        answer: "C",
        explanation: "In most cases, only the filename and mode parameters are required, with the rest of the parameters implicitly set to their default values.",
    },
    {
    ...
    },
    {
        ...
        answer: "C",
        explanation: "To close a file that has been opened, use the file object.close() function. To accomplish this, the Python language provides the close() method. When a file is closed, the system releases the memory that was allocated to it.",
    },
    {
        ...
        answer: "A",
        explanation: "Whenever a file is closed, Python ensures that any unwritten or unsaved data is flushed out or written to the file's header before the file is closed. As a result, it is always recommended that we close the file once our work is completed. Additionally, if the file object is reassigned to a different file, the previous file is automatically closed as well.",
    },
    {
    ...
    },
    {
        ...
        answer: "B",
        explanation: "The seek() method is used to position a file object at a specific location within a file's hierarchy.",
    },
    {
        question: "Amongst which of the following function is / are used to create a file and writing data?",
        options: {
            A: "append()",
            B: "open()",
            C: "close()",
    ...
    {
        question: "The readline() is used to read the data line by line from the text file.",
        options: {
            A: "True",
            B: "False",
            C: "-",
        ...
        answer: "A",
        explanation: "It is necessary to use readline() in order to read the data from a text file line by line. The lines are displayed by employing the print() command. When the readline() function reaches the end of the file, it will return an empty string.",
    },
    {
    ...
    },
    {
        ...
        answer: "D",
        explanation: "Unlike other types of files, text files contain only textual information, which can be represented by alphabets, numbers, and other special symbols. These types of files are saved with extensions such as.txt,.py,.c,.csv,.html, and so on. Each byte in a text file corresponds to one character in the text.",
    },
    {
        question: "The writelines() method is used to write multiple strings to a file?",
        options: {
            A: "True",
            B: "False",
            C: "-",
        ...
        answer: "A",
        explanation: "In order to write multiple strings to a file, the writelines() method is used. The writelines() method requires an iterable object, such as a list, tuple, or other collection of strings, to be passed to it.",
    },
];
